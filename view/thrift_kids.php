...
<meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="thrift kids.css">
...
<!-- cats -->
 <div class="container text-center">
  <div class="row row-cols-6 catr">
    ...
    <div class="col r1">
        <a href="cat_items_template.php?cat=kids&sub=clothes">
    ...
    <div class="col r2">
        <a href="cat_items_template.php?cat=kids&sub=toys">    
